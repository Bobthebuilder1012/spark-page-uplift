...
export const Route = createFileRoute("/parent/messages")({
  head: () => ({ meta: [{ title: "Messages — iTutor Parent" }] }),
  component: ParentMessages,
});

const THREADS = [
  { id: "ramdeen", name: "Mr. Ramdeen", subject: "Aliyah · Maths", last: "Aliyah's progress this week has been excellent.", time: "10m", unread: 1, color: "from-coral to-peach" },
  { id: "joseph", name: "Mr. Joseph", subject: "Aliyah · English", last: "Sharing the rubric for Friday's essay.", time: "2h", unread: 0, color: "from-lavender to-brand-soft" },
  { id: "khan", name: "Ms. Khan", subject: "Jaden · SEA Prep", last: "Quick note about Jaden's homework.", time: "Yesterday", unread: 2, color: "from-sky to-lavender" },
  { id: "support", name: "iTutor Support", subject: "Billing", last: "Your June invoice is ready.", time: "Mon", unread: 0, color: "from-brand to-brand-deep" },
];

const SAMPLE = [
  { from: "them", text: "Hi! Aliyah's progress this week has been excellent — she nailed the algebra paper.", time: "9:02" },
  { from: "me", text: "That's wonderful to hear, thank you for the update.", time: "9:10" },
  { from: "them", text: "I'll send the next set of practice questions tonight.", time: "9:12" },
];
